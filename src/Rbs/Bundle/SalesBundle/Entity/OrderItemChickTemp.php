...
class OrderItemChickTemp
{
     ...
     * @var OrderChickTemp
     *
     * @ORM\ManyToOne(targetEntity="Rbs\Bundle\SalesBundle\Entity\OrderChickTemp", inversedBy="orderItems", cascade={"persist", "remove"})

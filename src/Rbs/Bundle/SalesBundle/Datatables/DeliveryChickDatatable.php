...
/**
 * Class DeliveryChickDatatable
 *
 * @package Rbs\Bundle\SalesBundle\Datatables
 */
class DeliveryChickDatatable extends BaseDatatable
{
    /**
     * {@inheritdoc}
     */
    public function buildDatatable()
    {
        ...
        $this->ajax->setOptions(array(
            'url' => $this->router->generate('delivery_chick_list_ajax'),
            'type' => 'GET'
        ));

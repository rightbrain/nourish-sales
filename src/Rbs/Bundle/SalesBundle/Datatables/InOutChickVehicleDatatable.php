...
/**
 * Class InOutChickVehicleDatatable
 *
 * @package Rbs\Bundle\SalesBundle\Datatables
 */
class InOutChickVehicleDatatable extends BaseDatatable
{
    ...
    public function buildDatatable()
    {
        ...
        $this->ajax->setOptions(array(
            'url' => $this->router->generate('chick_truck_info_in_out_list_ajax'),
            'type' => 'GET'
        ));
            ...
            ->add(null, 'action', array(
                ...
                'actions' => array(
                    array(
                        ...
                        'role' => 'ROLE_CHICK_TRUCK_IN',
                        'render_if' => array('isIn')
                    ),
                    array(
                        'route' => 'chick_truck_out',
                        'route_parameters' => array(
                            'id' => 'id'
                        ),
                        'label' => 'Vehicle Out',
    ...
    {
        return 'chick_vehicle_in_out_datatable';
    }
}
